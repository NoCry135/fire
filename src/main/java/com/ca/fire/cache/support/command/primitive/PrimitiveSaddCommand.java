 ...
 *
 */
public class PrimitiveSaddCommand extends AbstractPrimitiveCommand implements CommandExecutor<Long> {
    public PrimitiveSaddCommand(Pool<Jedis> redisClient) {
        super(redisClient);
    }

    public PrimitiveSaddCommand(Pool<Jedis> redisClient, PrimitiveCommandExceptionHandler commandExceptionHandler) {
    ...
    public Long execute(final String key, final Object[] args) {
        return execute(new RedisCommandExecutor<Long>() {
            ...
            public Long execute(Jedis jedis) {
                ...
                return jedis.sadd(key, (String[]) args[0]);
            }
        });
    }
