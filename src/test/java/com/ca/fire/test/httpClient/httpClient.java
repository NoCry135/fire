package com.ca.fire.test.httpClient;
...
public class httpClient {
    ...
    public void doGetTestOne() {
        ...
        // 创建Get请求
        HttpGet httpGet = new HttpGet("http://localhost/employee/get");
    ...
    public void doGetTestWayOne() {
        ...
        // 创建Get请求
        HttpGet httpGet = new HttpGet("http://localhost/getEmployee" + "?" + params);
        // 响应模型
        CloseableHttpResponse response = null;
        try {
            // 配置信息
    ...
    public void doGetTestWayTwo() {
        ...
        try {
            ...
            params.add(new BasicNameValuePair("id", "18"));
            // 设置uri信息,并将参数集合放入uri;
            // 注:这里也支持一个键值对一个键值对地往里面放setParameter(String key, String value)
            uri = new URIBuilder().setScheme("http").setHost("localhost")
                    .setPort(80).setPath("/getEmployee")
